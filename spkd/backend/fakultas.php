...
<body>
    ...
    <div class="content">
        ...
        <div class="form-section mt-4">
            <div class="d-flex justify-content-between mb-3">
                ...
                <a href="add_fakultas.php" class="btn btn-primary">Add New Fakultas</a>
            </div>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr class='text-center'>
                                        ...
                                        <td>
                                            <a href='update_fakultas.php?id_fakultas={$row['id_fakultas']}' class='btn btn-warning btn-sm'>Edit</a>
                                            <a href='delete_fakultas.php?id_fakultas={$row['id_fakultas']}' class='btn btn-danger btn-sm'>Delete</a>
                                        </td>
                                      </tr>";
                            }
                        } else {
                            echo "<tr><td colspan='3' class='text-center'>No faculties found</td></tr>";
                        }
                    } else {
                        echo "<tr><td colspan='3' class='text-center'>Error fetching faculty data</td></tr>";
                    }
                    ?>
                    </tbody>
                </table>
    ...
    <script>
        ...
        document.getElementById('searchInput').addEventListener('keyup', debounce(function() {
            ...
            const rows = document.querySelectorAll('#fakultasTable tbody tr');
            rows.forEach(row => {
