...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container-fluid mt-4">
            ...
            <a href="add_subkriteria.php" class="btn btn-primary">Add New SubKriteria</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM master_subkriteria"; // Adjust the query as needed
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td class='actions'>
                                        <a href='edit-subkriteria.php?id={$row['id_kriteria']}' class='btn btn-warning'>Edit</a>
                                        <form action='delete-subkriteria.php' method='POST' style='display:inline;'>
